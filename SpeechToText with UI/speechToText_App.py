...
# house all the code for web app. Provides with input/output widgets.
import websockets
# interact with Assembly AI
import asyncio
# perform audio input and output in concurrent manner
import base64
# encode and decode audio signals before sent to api
import json
# read in audio output (transcribe text)
import pyaudio
# accept audio input processing 
import os
from pathlib import Path
# for navigating through the various files in the project and file processing
